...
//             <p className="text-2xl font-semibold">{order.product}</p>
...
//         {returns.length > 0 ? (
//           returns.map((ret) => (
//             <div key={ret.id} className="mb-8">
//               <p className="text-2xl font-semibold">{ret.product}</p>
//               <p className="text-lg text-gray-600 dark:text-gray-400">
...
const ReturnsOrders: React.FC = () => {
  // Dummy static data for demo; replace with API/user-data for production
  const orders = [
    {
      id: "ORD-00123",
      product: "Wireless Headphones",
